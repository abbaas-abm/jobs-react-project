...
const AddJob = () => {
  ...
  return (
   <>
    <h1 className="text-center text-2xl font-bold text-indigo-500 my-4">Add Job</h1>

    <div className="mx-auto max-w-[60%] my-5 bg-indigo-100 p-5">
        <form  onSubmit={e=> handleAddJob(e)} className="space-y-6">
            ...
            <div className="flex justify-end pt-6">
                <button type="submit"
                    className="inline-flex justify-center py-3 px-8 border border-transparent shadow-sm text-base font-medium rounded-lg text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition duration-150 ease-in-out transform hover:scale-105">
                    Post Job
                </button>
            </div>
        </form>
